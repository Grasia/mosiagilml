...
import mosi.ubiksim.UBIKSIMCONFIGGenerator;
...
public class HYDRACONFIGGenerator 
extends ingenias.editor.extension.BasicCodeGeneratorImp {
	...
	public HYDRACONFIGGenerator(String file) throws Exception {
		super(file);
		this.addTemplate("templates/scene_config.json");
	 ...
	 */
	public HYDRACONFIGGenerator(Browser browser) throws Exception {
		super(browser);
		this.addTemplate("templates/scene_config.json");
	}
	...
	public String getName() {
		return "scene_config.json Spec generator";
	}
	...
	public static void main(String args[]) throws Exception {
		System.out.println("HYDRA CONFIG Generator  (C) 2018 GISAI");
		...
		if (args.length==0){
			...
			if (args.length>=0){ 
				...
				ingenias.editor.Log.initInstance(new PrintWriter(System.out));
				HYDRACONFIGGenerator luagen = new HYDRACONFIGGenerator(args[0]);
